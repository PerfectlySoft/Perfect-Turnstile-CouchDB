# Perfect Turnstile with CouchDB [简体中文](README.zh_CN.md)
...
This project integrates Stormpath's Turnstile authentication system into a single package with Perfect, and a CouchDB ORM.
...
Define the connection details to access the CouchDB server:
